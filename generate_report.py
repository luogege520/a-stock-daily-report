        ...
        try:
            ...
            payload = {
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "你是一个专业的A股市场分析师。你必须严格基于提供的真实数据进行分析，不能编造或修改任何数值。你的分析应该客观、专业，基于数据给出合理的市场解读和投资建议。你必须使用中文回复。"
                    },
                    {
                        "role": "user",
                        "content": prompt
...
**注意**：请检查 STEPFUN_API_KEY 配置或稍后重试。
...
请检查环境变量 STEPFUN_API_KEY 是否正确设置。
"""
